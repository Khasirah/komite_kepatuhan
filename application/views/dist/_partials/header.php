...
<head>
  ...
  <title><?php echo $title; ?> &mdash; App Komite Kepatuhan</title>
  ...
  <?php
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/chocolat/dist/css/chocolat.css">
  <?php
  } elseif ($this->uri->segment(2) == "inputPrognosaAr" || $this->uri->segment(2) == "inputPrognosaKasi") { ?>
    ...
    <script src="<?php echo base_url(); ?>assets/js/page/inputPrognosaAr.js"></script>
  <?php } elseif ($this->uri->segment(2) == "addUser" || $this->uri->segment(2) == "editUser") { ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/izitoast/css/iziToast.min.css">
