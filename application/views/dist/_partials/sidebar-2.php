  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown <?php echo $this->uri->segment(1) == 'prognosa' ? 'active' : ''; ?>">
        <a class="nav-link has-dropdown" href="#"><i class="fas fa-hat-wizard"></i> Prognosa</a>
        <ul class="dropdown-menu">
          <li class="<?php echo $this->uri->segment(2) == 'daftarPrognosa' ? 'active' : ''; ?>"><a href="<?php echo base_url(); ?>prognosa/daftarPrognosa">Daftar Prognosa</a></li>
          <li class="<?php echo $this->uri->segment(2) == 'inputPrognosaAr' ? 'active' : ''; ?>"><a href="<?php echo base_url(); ?>prognosa/inputPrognosaAr">Input Prognosa AR</a></li>
          <li class="<?php echo $this->uri->segment(2) == 'inputPrognosaKasi' ? 'active' : ''; ?>"><a href="<?php echo base_url(); ?>prognosa/inputPrognosaKasi">Input Prognosa Kasi</a></li>
        </ul>
      </li>
      <!-- end main menu -->
      ...
      <li class="dropdown <?php echo $this->uri->segment(1) == 'user' ? 'active' : ''; ?>">
        <a class="nav-link has-dropdown" href="#"><i class="fas fa-users"></i> User Management</a>
        <ul class="dropdown-menu">
